              ...
              for ($k = 0; $k < count($registros); $k++) {
                ...
                if ($existencias[$j]->id_siembra == $registros[$k]->id_siembra) {
                  ...
                  if ($existencias[$j]->id_especie == $registros[$k]->id_especie) {
                    ...
                    $existencias[$j]->incremento_biomasa = ($existencias[$j]->peso_incremento * $existencias[$j]->cant_actual) ? (($existencias[$j]->peso_incremento * $existencias[$j]->cant_actual) / 1000) : 0;
                    $existencias[$j]->ganancia_peso_dia = $existencias[$j]->intervalo_tiempo ?  $existencias[$j]->peso_incremento / $existencias[$j]->intervalo_tiempo : 0;
