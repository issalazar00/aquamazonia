            ...
            <div class="row">
              ...
              <div class="form-group col-md-2">
                ...
                <select class="form-control" id="f_especie" v-model="f_especie">
                  <option value="-1" selected>Seleccionar</option>
                  <option :value="especie.id" v-for="especie in listadoEspecies" :key="especie.id">{{especie.especie}}
                  </option>
                </select>
              </div>
              <div class="form-group col-md-2">
                ...
                <select class="form-control" id="f_lote" v-model="f_lote">
                  <option value="-1" selected>Seleccionar</option>
                  <option :value="lote.lote" v-for="(lote, index) in lotes" :key="index">{{lote.lote}}</option>
                </select>
              </div>
              <div class="form-group col-md-2">
              ...
              <div class="form-group col-md-2">
                <downloadexcel class="btn btn-success form-control" :fetch="fetchData" :fields="json_fields"
                  name="informe-siembras-especies.xls" type="xls">
