              ...
              <div class="col-md-12 text-right ">
                <div class="form-group col-md-2">
                  <downloadexcel class="btn btn-success form-control" :fetch="fetchData" :fields="json_fields"
                    name="alimentacion.xls" type="xls">
              ...
              <table class="table table-sticky table-bordered table-striped table-sm table-sm-responsive">
                ...
                <tbody>
                  <tr v-for="(item, index) in listado" :key="index">
                    ...
                    <td>
                      {{ item.costo_kg | numeral('$0,0.00') }}
                    </td>
                    <td>
                      {{ item.costo_total_alimento | numeral('$0,0.00') }}
                    </td>
                    <td>
            ...
            <form class="row">
              <div class="col-md-6">
                ...
                <div class="form-group row ">
                  ...
                  <input type="date" class="form-control col-md-7" id="fecha_ra" aria-describedby="fecha_ra"
                    placeholder="Minutos hombre" v-model="form.fecha_ra">
                </div>

                <div class="form-group row">
                  <label for="minutos hombre" class="col-md-4">Minutos hombre</label>
                  <input type="number" class="form-control col-md-7" id="minutos_hombre" step="any"
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <input type="number" step="any" class="form-control col-md-7" id="kg_manana"
                    aria-describedby="cant_manana" placeholder="Kg Mañana" v-model="form.cant_manana">
                </div>
                <div class="form-group row">
                  <label for="cant_tarde" class="col-md-4">Kg tarde</label>
                  <input type="number" step="any" class="form-control col-md-7" id="cant_tarde"
                    aria-describedby="cant_tarde" placeholder="Kg tarde" v-model="form.cant_tarde">
                </div>

                <div class="form-group row">
                  <label for="detalles" class="col-md-4">Detalles</label>
                  <textarea class="form-control col-md-7" id="detalles" aria-describedby="detalles"
                    placeholder="Detalles" v-model="form.detalles"></textarea>
                </div>
